...
class PerfilRegistro extends StatefulWidget {
  ...
  @override
  State<PerfilRegistro> createState() => _PerfilRegistroState();
}

class _PerfilRegistroState extends State<PerfilRegistro> {
  ...
  Widget build(BuildContext context) {
    ...
    IdPersonaArguments argIdPersona = ModalRoute.of(context).settings.arguments;
    if (argIdPersona.persId == null) {
          ...
          child: Column(
            ...
            children: <Widget>[
              FutureBuilder<List<Persona>>(
                initialData: [],
                future: persForm
                    .getMostrarDatosRegistroPersona(argIdPersona.persId),
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: <Widget>[
                      FutureBuilder<List<Persona>>(
                        initialData: [],
                        future: persForm.getMostrarDatosRegistroPersona(
                            argIdPersona.persId),
                        builder: (BuildContext context,
                            AsyncSnapshot<List<Persona>> snapshot) {
                          List<Persona> pers = snapshot.data ?? [];
                          return Column(
                            children: <Widget>[
                              ...
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  /* CrearQR.addQR(id: argIdPersona.persId), */
                                  ButtonDescargar(
                                    id: argIdPersona.persId,
                                  )
                                ],
